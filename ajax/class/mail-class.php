...
/*
  -------------------------------------------------
  php_libmail v 2.001 (06.10.2014) webi.ru
  ...
  Ничего нового нет, только сделал ValidEmail статическим, чтобы можно было проверять валидность email без создания класс
